...
async function loadInitialData() {
    try {
        showNotification('Actualizando datos desde Firebase...', 'info');
...
async function loadActiveOrders() {
    try {
        console.log('Cargando pedidos activos desde Firebase...');
        
        // Consultar pedidos con estado diferente a 'delivered'
...
async function loadTablesStatus() {
    try {
        ...
        // En una implementación completa, tendrías una colección 'tables' en Firebase
...
function startAutoUpdates() {
    ...
    updateInterval = setInterval(() => {
        console.log('🔄 Actualizando automáticamente desde Firebase...');
        loadActiveOrders();
        updateDashboardStats();
