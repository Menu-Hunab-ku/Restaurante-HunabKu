...
async function loadActiveOrders() {
    ...
    try {
        ...
        // Incluir todos los estados: pending, preparing, cooking, ready, delivered (solo excluir cancelled para vista activa)
                ...
                <div class="flex gap-2 flex-wrap">
                    ${order.Estado === 'pending' ? `
                        <button onclick="updateOrderStatus('${order.ID}', 'preparing')" 
                            ...
                            <i class="fas fa-utensils mr-2"></i> Preparar
                        </button>
                    ` : ''}
                    ${order.Estado === 'preparing' ? `
                        <button onclick="updateOrderStatus('${order.ID}', 'cooking')" 
                                class="btn-warning flex-1">
                            <i class="fas fa-fire mr-2"></i> Cocinando
                        </button>
                    ` : ''}
                    ...
                    ${order.Estado === 'ready' ? `
                        <button onclick="updateOrderStatus('${order.ID}', 'delivered')" 
                            ...
                            <i class="fas fa-truck mr-2"></i> Entregar
                        </button>
                    ` : ''}
